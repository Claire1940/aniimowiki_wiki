...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Aniimo Wiki",
    description: "Read the Terms of Service for Aniimo Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Aniimo Wiki",
      description: "Terms and conditions for using Aniimo Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Aniimo Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Aniimo Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Aniimo Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Aniimo Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the creature-catching RPG "Aniimo". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Aniimo Wiki is NOT affiliated with, endorsed by, or associated with
              Pawprint Studio, FunPlus, the official developers of Aniimo, or platform holders such as Steam,
              Epic Games, PlayStation, and Xbox. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Aniimo Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Pawprint Studio and/or the developers of Aniimo. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ANIIMO WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Aniimo Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@aniimowiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@aniimowiki.wiki</a>
            </p>
            <p>
